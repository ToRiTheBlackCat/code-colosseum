          ...
          {unlockedBadges.map((badge) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div
                  className={`w-16 h-16 rounded-xl bg-gradient-to-br ${badge.color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}
                >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between">
                    <span
                      className={`px-2 py-1 rounded-lg border text-xs ${getRarityColor(
                        badge.rarity
                      )}`}
                    >
                      {badge.rarity}
