...
import { Play, RotateCcw, Send, Sparkles, Clock, CheckCircle2, XCircle } from 'lucide-react';
...
export function ProblemDetail({ problemId, onToggleAIMentor, showAIMentor }: ProblemDetailProps) {
  ...
  return (
    <div className="h-[calc(100vh-73px)] flex">
      ...
      <div className={`${showAIMentor ? 'w-[35%]' : 'w-1/2'} border-r border-gray-800 flex flex-col transition-all duration-300`}>
        <div className="border-b border-gray-800 flex items-center px-6 py-3 gap-2">
          <button
            onClick={() => setActiveTab('description')}
            className={`px-4 py-2 rounded-lg transition-all ${
              activeTab === 'description' ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white'
            }`}
          >
            Description
          </button>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg transition-all ${
              activeTab === 'solutions' ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white'
            }`}
          >
            Solutions
          </button>
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className={`px-3 py-1 rounded-lg border text-sm ${getDifficultyColor(problem.difficulty)}`}>
                    {problem.difficulty}
                  </span>
                </div>
              ...
              <div>
                ...
                {problem.examples.map((example, idx) => (
                  <div key={idx} className="mb-4 p-4 bg-[#121212] border border-gray-800 rounded-lg">
                    <div className="mb-2">
      ...
      <div className={`${showAIMentor ? 'w-[65%]' : 'w-1/2'} flex flex-col transition-all duration-300`}>
          ...
          <div className="border-t border-gray-800 bg-[#0a0a0a]">
              ...
              <div className="border-b border-gray-800 p-4 bg-gradient-to-r from-green-500/5 to-transparent">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm text-gray-400 ml-auto">
                    Submitted to {submissionStats.totalSubmissions.toLocaleString()} total submissions
                  </span>
                </div>
                  ...
                  <div>
                    ...
                    <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ width: `${submissionStats.runtimePercentile}%` }}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ width: `${submissionStats.memoryPercentile}%` }}
                      />
                    </div>
                    <div className="text-xs text-gray-500 mt-1">
            ...
            <div className="p-4 max-h-[250px] overflow-y-auto">
              <h3 className="mb-3 flex items-center gap-2">
                Test Results
                <span className={`text-sm ${testResults.every(t => t.passed) ? 'text-green-400' : 'text-red-400'}`}>
                ...
                {testResults.map((result, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-gray-500 ml-auto">{result.time} | {result.memory}</span>
                    </div>
                    {!result.passed && (
                      <div className="text-sm space-y-1 ml-6">
                        <div className="text-gray-400">Expected: <code className="text-green-400">{result.expected}</code></div>
                        <div className="text-gray-400">Got: <code className="text-red-400">{result.output}</code></div>
                      </div>
                    )}
                  </div>
                ))}
