...
import { PetSystem, type Pet, type PetType, petTemplates } from "./PetSystem";
...
export function Shop() {
  const [selectedCategory, setSelectedCategory] = useState<
    "all" | "badge" | "frame" | "theme" | "boost"
  >("all");
  const [activeTab, setActiveTab] = useState<
    "regular" | "premium" | "pets" | "subscription"
  >("regular");
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-400">
              Customize your profile and boost your progress
            </p>
          </div>
        ...
        <>
            ...
            {filteredItems.map((item) => {
              ...
              return (
                ...
                >
                  {/* Item Preview */}
                  <div
                    className={`h-48 bg-gradient-to-br ${item.color} relative flex items-center justify-center`}
                  >
                    {item.category === "frame" && (
                      <div
                        className={`w-24 h-24 rounded-full bg-gray-900 flex items-center justify-center ${item.preview}`}
                      >
                    ...
                    <div className="absolute top-3 left-3">
                      <span
                        className={`px-3 py-1 rounded-lg border text-xs ${getRarityColor(
                          item.rarity
                        )}`}
                      >
                        {item.rarity}
          ...
          <div className="mt-12 bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                {
                  action: "Solve Easy Problem",
                  coins: "+10",
                  icon: CheckCircle2,
                  color: "text-green-400",
                },
                {
                  action: "Solve Medium Problem",
                  coins: "+25",
                  icon: CheckCircle2,
                  color: "text-yellow-400",
                },
                {
                  action: "Solve Hard Problem",
                  coins: "+50",
                  icon: CheckCircle2,
                  color: "text-red-400",
                },
                ...
                {
                  action: "Weekly Contest Top 100",
                  coins: "+200",
                  icon: Award,
                  color: "text-yellow-400",
                },
                {
                  action: "Monthly Challenge",
                  coins: "+500",
                  icon: Crown,
                ...
                <div
                  key={idx}
                  className="bg-[#121212] border border-gray-800 rounded-lg p-4"
                >
      ...
      {activeTab === "premium" && (
        <div>
          <div className="mb-6 p-6 bg-gradient-to-br from-pink-500/10 to-purple-500/10 border border-pink-500/20 rounded-xl">
            ...
            <p className="text-gray-400">
              These special items can only be purchased with Gems. They offer
              unique features and exclusive designs.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Animated fire effect that never goes out. Pure prestige.",
                price: 300,
                rarity: "Legendary",
                icon: "🔥",
              ...
              },
              {
                ...
                name: "Galaxy Frame",
                description:
                  "Animated galaxy swirl around your avatar. Mesmerizing!",
                price: 500,
                rarity: "Legendary",
                icon: "🌌",
              ...
              },
              {
                ...
                name: "Rainbow Trail",
                description:
                  "Leave a rainbow trail wherever you go on the platform.",
                price: 400,
                rarity: "Epic",
                icon: "🌈",
              ...
              },
              {
                ...
                description:
                  'Exclusive "Code Master" title displayed on your profile.',
                price: 350,
                rarity: "Legendary",
                icon: "👑",
              ...
              },
              {
                ...
                description:
                  "Create your own custom theme with full color control.",
                price: 600,
                rarity: "Legendary",
                icon: "🎨",
              ...
              >
                <div
                  className={`h-48 bg-gradient-to-br ${item.color} flex items-center justify-center text-6xl relative`}
                >
                  {item.icon}
                  <div className="absolute top-3 left-3">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 rounded-lg transition-all">
                      Purchase
                    </button>
                  </div>
                </div>
